...
cf2py intent(in) :: n,a,b,x
cf2py intent(out) :: y,dy,d2y  
...
cf2py double precision,intent(out),dimension(n) :: cs,dz
...
********************************************************************    
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)                               
      DIMENSION ET(0:N), VN(0:N)   

cf2py integer, intent(in) :: n
cf2py double precision, intent(in) :: a,b
cf2py double precision,intent(out),dimension(0:n) :: et,vn
...
cf2py integer, intent(in) :: n
cf2py double precision,intent(out),dimension(0:n) :: et
...
cf2py integer, intent(in) :: n
cf2py double precision,intent(in),dimension(0:n) :: co
cf2py double precision,intent(out),dimension(0:n) :: qn
...
*********************************************************************   
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)                               
      DIMENSION QN(0:N), CD(0:N), DQN(0:N)  

cf2py integer, intent(in) :: n
cf2py double precision,intent(in),dimension(0:n) :: qn
cf2py double precision,intent(out),dimension(0:n) :: cd,dqn
